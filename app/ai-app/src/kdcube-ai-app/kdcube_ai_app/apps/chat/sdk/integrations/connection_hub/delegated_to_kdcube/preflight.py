...
"""KDCube client binding for Connection Hub connected-account preflight."""
...
from kdcube_ai_app.apps.chat.sdk.integrations.connection_hub.delegated_to_kdcube.client import (
    DelegatedToKdcubeClient,
)


_core = import_module("connection_hub.delegated_to_kdcube.preflight")
