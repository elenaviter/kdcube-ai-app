...
"""KDCube host bindings for Prokura delegated-access automation cards."""
...
_core = import_module("prokura.delegated_credentials.automation_access")
...
class AutomationAccessService(_core.AutomationAccessService):
    """Compose Prokura's delegated-access service with KDCube host ports."""
...
async def notify_delegated_access_changed(
    ...
    *,
    ...
    """Emit a Prokura registry mutation through KDCube's chat relay."""
