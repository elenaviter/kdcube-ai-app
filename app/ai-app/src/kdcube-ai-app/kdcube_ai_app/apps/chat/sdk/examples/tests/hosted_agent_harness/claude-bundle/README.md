---
id: repo:kdcube-ai-app/app/ai-app/src/kdcube-ai-app/kdcube_ai_app/apps/chat/sdk/examples/tests/hosted_agent_harness/claude-bundle/README.md
...
see_also:
  - repo:kdcube-ai-app/app/ai-app/src/kdcube-ai-app/kdcube_ai_app/apps/chat/sdk/examples/tests/hosted_agent_harness/README.md
...
This app bundle is the target used by the hosted Agent Harness acceptance
fixture. The bundle runs Claude Code inside a prepared KDCube deployment; the
parent module drives it through chat and SSE.
...
```bash
.venv/bin/python -m kdcube_ai_app.apps.chat.sdk.examples.tests.hosted_agent_harness.claude \
