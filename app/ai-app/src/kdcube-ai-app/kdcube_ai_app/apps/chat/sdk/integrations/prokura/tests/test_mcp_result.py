...
from kdcube_ai_app.apps.chat.sdk.integrations.prokura import mcp_result
...
def test_agent_grant_consent_announced_from_self_describing_block(monkeypatch):
    ...
    from kdcube_ai_app.apps.chat.sdk.integrations.prokura import mcp_consent as consent_mod
