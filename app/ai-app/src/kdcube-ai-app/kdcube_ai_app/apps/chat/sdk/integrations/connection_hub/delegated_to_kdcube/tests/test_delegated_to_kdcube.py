...
from kdcube_ai_app.apps.chat.sdk.integrations.connection_hub.delegated_to_kdcube.store import credential_id_for
from kdcube_ai_app.apps.chat.sdk.integrations.connection_hub.delegated_to_kdcube import store as ui_store
...
def test_consent_bookkeeping_stays_off_the_event_loop():
    ...
    from kdcube_ai_app.apps.chat.sdk.integrations.connection_hub.delegated_to_kdcube import store as store_mod
...
def test_clean_claims_fails_closed_on_empty_selection():
    ...
    from kdcube_ai_app.apps.chat.sdk.integrations.connection_hub.delegated_to_kdcube.operations import (
        _clean_claims,
    )
...
def test_google_adapter_requests_only_selected_scopes():
    ...
    from connection_hub.delegated_to_kdcube.providers.google import (
        GoogleOAuthAdapter,
    )
