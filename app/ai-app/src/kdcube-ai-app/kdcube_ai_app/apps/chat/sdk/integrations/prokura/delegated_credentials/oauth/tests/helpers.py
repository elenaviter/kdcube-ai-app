...
from prokura.authority_registry import AuthorityRegistry
from prokura.delegated_credentials.oauth.authority import OAuthDelegatedClientAuthorityProvider
from kdcube_ai_app.apps.chat.sdk.integrations.prokura.delegated_credentials.oauth.config import oauth_delegated_config
from kdcube_ai_app.apps.chat.sdk.integrations.prokura.delegated_credentials.oauth.http.discovery import router as discovery_router
from kdcube_ai_app.apps.chat.sdk.integrations.prokura.delegated_credentials.oauth.http.routes import router as oauth_routes_router
