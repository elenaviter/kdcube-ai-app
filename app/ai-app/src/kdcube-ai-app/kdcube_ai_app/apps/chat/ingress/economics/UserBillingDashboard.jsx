...
var UserBillingDashboard = function () {
    ...
    var _f = (0, react_1.useState)('initializing'), configStatus = _f[0], setConfigStatus = _f[1];
    var _g = (0, react_1.useState)(false), loading = _g[0], setLoading = _g[1];
    var _h = (0, react_1.useState)(null), error = _h[0], setError = _h[1];
    var _j = (0, react_1.useState)(null), breakdown = _j[0], setBreakdown = _j[1];
    var _k = (0, react_1.useState)([]), plans = _k[0], setPlans = _k[1];
    var _l = (0, react_1.useState)(null), subscription = _l[0], setSubscription = _l[1];
    var _m = (0, react_1.useState)('10'), topupAmount = _m[0], setTopupAmount = _m[1];
    var _o = (0, react_1.useState)(false), cancelConfirm = _o[0], setCancelConfirm = _o[1];
    ...
    var loadData = function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, brk, pData, subData, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    setLoading(true);
                ...
                case 2:
                    _a = _b.sent(), brk = _a[0], pData = _a[1], subData = _a[2];
                    if (brk)
                        setBreakdown(brk);
                    if (pData)
            ...
            <div className="mx-auto flex h-full max-w-5xl flex-col gap-4 overflow-hidden">
                ...
                {!loading && breakdown && (<div className="min-h-0 overflow-y-auto pr-1">
                        <div className="flex flex-col gap-4">
                            ...
                            {((_e = breakdown.subscription_balance) === null || _e === void 0 ? void 0 : _e.has_subscription) && (<Card className="p-4">
