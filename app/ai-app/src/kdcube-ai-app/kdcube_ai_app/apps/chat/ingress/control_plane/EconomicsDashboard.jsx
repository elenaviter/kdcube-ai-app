...
var EconomicsAdmin = function () {
    ...
    var _72 = (0, react_1.useState)(''), lineageRequestId = _72[0], setLineageRequestId = _72[1];
    var _73 = (0, react_1.useState)(null), lineageResult = _73[0], setLineageResult = _73[1];
    var _74 = (0, react_1.useState)(false), loadingLineage = _74[0], setLoadingLineage = _74[1];
    // Subscriptions
    var _75 = (0, react_1.useState)('internal'), subProvider = _75[0], setSubProvider = _75[1];
    var _76 = (0, react_1.useState)(''), subUserId = _76[0], setSubUserId = _76[1];
    var _77 = (0, react_1.useState)(''), subPlanId = _77[0], setSubPlanId = _77[1];
    var _78 = (0, react_1.useState)(''), subStripePriceId = _78[0], setSubStripePriceId = _78[1];
    var _79 = (0, react_1.useState)(''), subStripeCustomerId = _79[0], setSubStripeCustomerId = _79[1];
    var _80 = (0, react_1.useState)(''), subPriceHint = _80[0], setSubPriceHint = _80[1];
    var _81 = (0, react_1.useState)(''), planId = _81[0], setPlanId = _81[1];
    var _82 = (0, react_1.useState)('internal'), planProvider = _82[0], setPlanProvider = _82[1];
    var _83 = (0, react_1.useState)(''), planStripePriceId = _83[0], setPlanStripePriceId = _83[1];
    var _84 = (0, react_1.useState)('0'), planPriceCents = _84[0], setPlanPriceCents = _84[1];
    var _85 = (0, react_1.useState)(true), planActive = _85[0], setPlanActive = _85[1];
    var _86 = (0, react_1.useState)(''), planNotes = _86[0], setPlanNotes = _86[1];
    var _87 = (0, react_1.useState)([]), subscriptionPlans = _87[0], setSubscriptionPlans = _87[1];
    var _88 = (0, react_1.useState)(false), loadingPlans = _88[0], setLoadingPlans = _88[1];
    var _89 = (0, react_1.useState)(''), subLookupUserId = _89[0], setSubLookupUserId = _89[1];
    var _90 = (0, react_1.useState)(null), subscription = _90[0], setSubscription = _90[1];
    var _91 = (0, react_1.useState)(''), subBudgetUserId = _91[0], setSubBudgetUserId = _91[1];
    var _92 = (0, react_1.useState)(''), subBudgetUsdAmount = _92[0], setSubBudgetUsdAmount = _92[1];
    var _93 = (0, react_1.useState)(''), subBudgetNotes = _93[0], setSubBudgetNotes = _93[1];
    var _94 = (0, react_1.useState)(false), subBudgetForceTopup = _94[0], setSubBudgetForceTopup = _94[1];
    var _95 = (0, react_1.useState)(''), subSweepUserId = _95[0], setSubSweepUserId = _95[1];
    var _96 = (0, react_1.useState)(null), subscriptionBalance = _96[0], setSubscriptionBalance = _96[1];
    var _97 = (0, react_1.useState)(''), subReapUserId = _97[0], setSubReapUserId = _97[1];
    var _98 = (0, react_1.useState)('500'), subReapLimitPeriods = _98[0], setSubReapLimitPeriods = _98[1];
    var _99 = (0, react_1.useState)('500'), subReapPerPeriodLimit = _99[0], setSubReapPerPeriodLimit = _99[1];
    var _100 = (0, react_1.useState)(''), walletRefundUserId = _100[0], setWalletRefundUserId = _100[1];
    var _101 = (0, react_1.useState)(''), walletRefundPaymentIntentId = _101[0], setWalletRefundPaymentIntentId = _101[1];
    var _102 = (0, react_1.useState)(''), walletRefundUsdAmount = _102[0], setWalletRefundUsdAmount = _102[1];
    var _103 = (0, react_1.useState)(''), walletRefundNotes = _103[0], setWalletRefundNotes = _103[1];
    var _104 = (0, react_1.useState)(''), cancelSubUserId = _104[0], setCancelSubUserId = _104[1];
    var _105 = (0, react_1.useState)(''), cancelSubStripeId = _105[0], setCancelSubStripeId = _105[1];
    var _106 = (0, react_1.useState)(''), cancelSubNotes = _106[0], setCancelSubNotes = _106[1];
    var _107 = (0, react_1.useState)('all'), stripeReconcileKind = _107[0], setStripeReconcileKind = _107[1];
    var _108 = (0, react_1.useState)('all'), pendingStripeKind = _108[0], setPendingStripeKind = _108[1];
    var _109 = (0, react_1.useState)([]), pendingStripeItems = _109[0], setPendingStripeItems = _109[1];
    var _110 = (0, react_1.useState)(false), loadingPendingStripe = _110[0], setLoadingPendingStripe = _110[1];
    var _111 = (0, react_1.useState)(''), pendingEconomicsKind = _111[0], setPendingEconomicsKind = _111[1];
    var _112 = (0, react_1.useState)(''), pendingEconomicsUserId = _112[0], setPendingEconomicsUserId = _112[1];
    var _113 = (0, react_1.useState)([]), pendingEconomicsItems = _113[0], setPendingEconomicsItems = _113[1];
    var _114 = (0, react_1.useState)(false), loadingPendingEconomics = _114[0], setLoadingPendingEconomics = _114[1];
    var _115 = (0, react_1.useState)(''), subHistoryUserId = _115[0], setSubHistoryUserId = _115[1];
    var _116 = (0, react_1.useState)('closed'), subHistoryStatus = _116[0], setSubHistoryStatus = _116[1];
    var _117 = (0, react_1.useState)([]), subPeriods = _117[0], setSubPeriods = _117[1];
    var _118 = (0, react_1.useState)([]), subLedger = _118[0], setSubLedger = _118[1];
    var _119 = (0, react_1.useState)(''), subSelectedPeriodKey = _119[0], setSubSelectedPeriodKey = _119[1];
    var _120 = (0, react_1.useState)(false), loadingHistory = _120[0], setLoadingHistory = _120[1];
    var _121 = (0, react_1.useState)(''), subsProviderFilter = _121[0], setSubsProviderFilter = _121[1];
    var _122 = (0, react_1.useState)([]), subsList = _122[0], setSubsList = _122[1];
    var _123 = (0, react_1.useState)(null), economicsRef = _123[0], setEconomicsRef = _123[1];
    ...
    var handleExportAbsorptionCsv = function () { return __awaiter(void 0, void 0, void 0, function () {
        var parsed, days, csv, blob, url, a, err_17;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    clearMessages();
    ...
    var handleTopupSubscriptionBudget = function (e) { return __awaiter(void 0, void 0, void 0, function () {
        var res, err_23, raw, friendly, m, parsed;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    e.preventDefault();
                ...
                case 3:
                    err_23 = _a.sent();
                    raw = err_23.message || 'Top-up failed';
                    friendly = raw;
                    m = raw.match(/\{[\s\S]*\}/);
                    if (m) {
                        try {
    ...
    var handleReapSubscriptionReservations = function (e) { return __awaiter(void 0, void 0, void 0, function () {
        var res, expired, periods, err_25;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    e.preventDefault();
